  ...
  return (
    <AppFrame>
      ...
      >
        ...
        <form
          action={submitAction}
          className="relative my-8  flex flex-col items-center text-center"
        >
          <motion.h1 variants={AnimWrap.bounceUpA} className="font-serif-xl mb-4 text-center">
            Who&apos;s grandma&apos;s
            <br /> favourite? It&apos;s you!
          </motion.h1>
          <motion.div variants={AnimWrap.bounceUpB} className="font-serif-sm max-w-[26ch]">
